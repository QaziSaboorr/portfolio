...
const Projects = () => {
  return (
    <div class="container m-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-10 h-[900px] py-10">
      ...
      <div class="tile bg-gray-900 text-white text-center ">
        ...
        <img src={textutils} />
        <p className="text-white">
          I started to dive into world of React starting with this app. This a
          simple app from which you can perform functions on the text in box.
      ...
      <div class="tile bg-gray-900 text-white text-center ">
        ...
        <p className="text-white ">
          ...
          app from UML to GUI and some amazing logic !
        </p>
        <a
